...
class MyTestCase(unittest.TestCase):
    ...
    def test_hight(self):
        self.assertEqual(self.tree.hight(), 0)
        self.tree.insert(5)
        self.assertEqual(self.tree.hight(), 1)
        self.insert(6)
        self.insert(4)
        self.insert(3)
        self.assertEqual(self.tree.hight(), 2)

    def test_preorder(self):
        self.assertIsNone(self.tree.preorder())
        self.tree.insert(5)
        self.tree.insert(4)
        self.tree.insert(9)
        self.tree.insert(7)
    ...
    def test_inorder(self):
        self.assertIsNone(self.tree.inorder())
        self.tree.insert(5)
        self.tree.insert(4)
        self.tree.insert(9)
        self.tree.insert(7)
    ...
    def test_postorder(self):
        self.assertIsNone(self.tree.postorder())
        self.tree.insert(5)
        self.tree.insert(4)
        self.tree.insert(9)
        self.tree.insert(7)
    ...
    def test_search(self):
        ...
        self.assertFalse(self.tree.serach(15))
    ...
    def test_delete(self):
        ...
        self.delete(4)
        self.assertEqual(self.test_postorder(), [2, 7, 9, 5])
